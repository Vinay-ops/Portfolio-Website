  ...
  <div class="container">
    <aside class="sidebar">
      ...
      <div class="skills-section">
        ...
        <div class="skills-group">
          <span class="skill-label">Databases & Tools</span>
          <div class="skill-tags">
      ...
      <div class="languages-section" style="margin-top: 30px;">
        <h3 class="sidebar-title">Languages</h3>
        <div style="font-size: 11px; color: var(--text-muted);">
          <p style="margin-bottom: 5px;">• English (Professional)</p>
          <p style="margin-bottom: 5px;">• Hindi (Native)</p>
          <p style="margin-bottom: 5px;">• Marathi (Native)</p>
        </div>
      </div>
    </aside>
    ...
    <main class="main-content">
      <header>
        <h1>VINAY BHOGAL</h1>
        <div class="job-title">Aspiring Android & Flutter Full-Stack Developer</div>
      </header>
        ...
        <div class="project-grid">
          ${PROJECTS.slice(0, 4).map(
            ...
            <div class="project-card">
              ...
              <p class="item-desc" style="margin-bottom: 0;">${project.description}</p>
            </div>
          `
          ).join("")}
        </div>
