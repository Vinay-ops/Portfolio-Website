      ...
      <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
        <div className="relative">
          ...
          <div className="mt-8 space-y-6 text-base font-bold text-neo-black dark:text-neo-white">
            <p>
              I&apos;m Vinay — an Information Technology student from Mumbai working towards becoming a high-impact Software Engineer. I&apos;m sharpening my skills in Android and Flutter development while building real-world projects.
            </p>
            <p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              {["Android", "Flutter", "Mobile UX", "Kotlin", "Firebase"].map((tag, index) => {
